...
// import CreateFeedbackItemModal from 'src/components/CreateFeedbackItemModal'
    ...
    <ContainerLayout headerBtns={headerBtns}>
      <div className="grid">
        <div className="divide-y">
          <p className="px-6 py-3 leading-5 text-gray-500 whitespace-nowrap">No insights added yet</p>
        </div>
      </div>
    </ContainerLayout>
  )
